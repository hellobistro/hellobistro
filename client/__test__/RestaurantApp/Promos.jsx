...
import { PromosContainer } from '../../src/components/Containers';

// Setup 
const store = createMockStore(testState);
const wrapper = shallowWithStore(<PromosContainer />, store);

describe('Promos Component', () => {
  it('should render Promos component', () => {
    ...
    global.expect(wrapper.dive().text()).to.contain('This is the Promos component');
  });
});